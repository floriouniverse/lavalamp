...
👉 https://floriouniverse.github.io/lavalamp/
---
...
### En ligne
Accédez directement à la version web via le lien ci-dessus.
...
Un Discord pourra être créé pour la collaboration et les idées.
...
### Architecture
Vibe Code (Gemini + GPT + prompts + modifications personnelles)
...
- [ ] 🛑Bug: Delta time moteur = possible conflit de vitesse selon les appareils. Bloquer F12 = pas de de possibilité d'"inspecter",  identifier les failles.
- **V0.4** 
